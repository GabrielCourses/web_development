...
El atributo <code>type="radio"</code>:
...
Comenzamos ingresando una caja de texto, enseguida del elemento <code>form</code>:
...
Una tarea común en los formularios es validar la información de entrada, es decir, restringir la entrada del campo a solo unas opciones. Lo anterior lo conseguimos en html con el elemento <coe>select<code>.
...
Dentro de la etiqueta <code>body</code> escribimos el siguiente código:
